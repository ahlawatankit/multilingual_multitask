...
sgd =SGD(lr=0.00001, decay=1e-8, momentum=0.8, nesterov=True)
...
class HLSTM:
    ...
    def build_model(self):
        ...
        if self.task=='intent':
            flat_in=LSTM(self.lstm_hidden_size, activation='relu', kernel_initializer='random_uniform',return_sequences=False)(embed_word_out)
             #flat_in=Dropout(0.1)(flat_in)
            intent_out = Dense(units=UNIT2, activation='relu', kernel_initializer='random_uniform')(flat_in)
            ...
            flat_in=LSTM(self.lstm_hidden_size, activation='relu', kernel_initializer='random_uniform',return_sequences=True)(embed_word_out)
            slot_out = Dense(units=UNIT2, activation='relu', kernel_initializer='random_uniform')(flat_in)
            slot_out=Dropout(0.2)(slot_out)
