...
class HLSTM:
    def __init__(self,char_embedding,word_embedding,INTENT_CLASS1,SLOT_CLASS1,INTENT_CLASS2,SLOT_CLASS2,dataset,language1,language2,task,CHAR_LEVEL=False,MAX_WORD=90,MAX_CHAR_WORD=25,config_charCNN=CharCNN_config,config_wordCNN=wordCNN_config,lstm_cell=128):
        ...
        self.task=task
        self.lstm_hidden_size=lstm_cell
        self.model='HLSTM'
    ...
    def save_model(self,model):
         model_path = './models/single_language/multi_task/'+self.dataset+'_'+self.language+'_'+self.task+'_'+'HLSTM.json'
         weights_path = './models/single_language/multi_task/'+self.dataset+'_'+self.language+'_'+self.task+'_'+'HLSTM_weights.hdf5'
