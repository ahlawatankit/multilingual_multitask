...
UNIT1=64
UNIT2=129
adam = Adam(lr=0.0001, beta_1=0.99, beta_2=0.95, epsilon=None, decay=0.00000001, amsgrad=True)
sgd =SGD(lr=0.001, decay=1e-6, momentum=0.95, nesterov=True)
losses = 'categorical_crossentropy'
class HCNN:
    def __init__(self,char_embedding,word_embedding,INTENT_CLASS1,SLOT_CLASS1,INTENT_CLASS2,SLOT_CLASS2,dataset,language1,language2,task,CHAR_LEVEL=False,MAX_WORD=90,MAX_CHAR_WORD=25,config_charCNN=CharCNN_config,config_wordCNN=wordCNN_config):
    ...
    def build_model(self):
       ...
       #first language model
        ...
        intent_out_lang1=Dropout(0.4)(intent_out_lang1)
        ...
        slot_in_lang1=Reshape((self.MAX_WORD,512))(intermediate_feature)
       ...
       # slot_out=Dropout(0.1)(slot_out)
        ...
        intent_out_lang2=Dropout(0.4)(intent_out_lang2)
        ...
        slot_in_lang2=Reshape((self.MAX_WORD,512))(intermediate_feature)
